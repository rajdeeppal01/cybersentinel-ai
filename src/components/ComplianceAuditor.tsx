...
import { ShieldCheck, ClipboardCheck, Sparkles, FileWarning, Eye, Cpu, Layers, Download } from 'lucide-react';
...
export default function ComplianceAuditor({ onUpdateScore }: ComplianceAuditorProps) {
  ...
  const exportPDF = async () => {
    ...
    pdf.save('CyberSentinel-GRC-Report.pdf');
  };
          ...
          {!auditResult ? (
            ...
            {usedFallback && (
              <div style={{ background: 'rgba(255, 159, 0, 0.05)', border: '1px solid var(--neon-orange)', padding: '10px', borderRadius: '4px', fontSize: '0.75rem', color: 'var(--neon-orange)' }}>
                ⚠️ <strong>Note:</strong> The local on-device AI failed to initialize. This audit was dynamically generated by the secure Vercel Cloud Backend instead.
              </div>
            )}
